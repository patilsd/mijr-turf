...
//             className="mt-1 p-1 text-sm block w-full border-1 border-gray-400 rounded-md shadow-md"
//           />
//         </div>
//         <div>
//           <label className="block text-sm font-medium text-gray-700">
...
//             className="mt-1 p-1 block w-full text-sm border-1 border-gray-400 rounded-md shadow-md"
//           />
//         </div>
//         <div>
//           <label className="block text-sm font-medium text-gray-700">
...
export const AddMemberForm: React.FC<AddMemberFormProps> = ({
  ...
  return (
    <form
      ...
      className="p-4 border rounded-md bg-white shadow-md max-w-4xl mx-auto"
    >
